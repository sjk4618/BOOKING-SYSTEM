...
3. Load `.ai/skills/test-guide/SKILL.MD`.
...
- Use `.ai/skills/test-guide/SKILL.MD` as the primary testing workflow.
- Use `.ai/skills/java-standard/SKILL.MD` for test naming, readability, and Java style.
- Use `.ai/skills/springboot-standard/SKILL.MD` for controller, service, validation, and exception behavior.
- Use `.ai/skills/jpa-standard/SKILL.MD` for repository, entity, transaction, and MySQL integration tests.
