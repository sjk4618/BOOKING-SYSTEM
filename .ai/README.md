...
- 기능 구현 계획 및 아키텍처 설계: `agents/plan.md` + `skills/springboot-standard.md` + `skills/jpa-standard.md` + `skills/java-standard.md` + `skills/test-guide.md`
...
- JPA 중심 변경 계획: `agents/plan.md` + `skills/jpa-standard.md`
